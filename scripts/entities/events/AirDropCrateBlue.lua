CreateItemTable("AirDropCrateBlue");

-- Called when the crate is initially dropped
function AirDropCrateBlue:OnDropped()
	--Log("AirDropCrateBlue - OnDropped")
end
...
function AirDropCrateBlue:OnLanding()
	--Log("AirDropCrateBlue - OnLanding")
end
...
function AirDropCrateBlue:OnLanded()
	--Log("AirDropCrateBlue - OnLanded")
