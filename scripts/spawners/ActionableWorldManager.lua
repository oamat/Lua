...
--]]
	...
	actionables =
	{
		...
		--------------------------------------------------
		{
			...
			uses = 2,
			regenerate = 20,
			percentage = 65, -- that is about one amcoin per town per hour.
...
--]]
		...
		-----------------------------------------------------------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/lobster_cage.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
			--minRefDiameter = 1, -- smallest (bike is 2, f100/sedan about 6, bus is 13)
			--maxRefDiameter = 2, -- 
			regenerate = 120,
			percentage = 75,
			spawn = "RandomLobsterLoot",		
			gridsize = 1,
			forceinteraction = true,
			--tactical = false,
			--toolrequired = true,
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Castor_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Rabbit_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Rat_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Snake_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		-- Squirrel Cage NZ                                     --NationZ
		--------------------------------------------------
		{
			text = "Search Squirrel",
			fail = "Nothing to harvest",
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Squirrel_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/cages/Turtle_cage_nz.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 1, -- this is 5 basepart upgrades
		...
		--------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/farm/ChickenCoop/chicken_coop.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 2, -- this is 5 basepart upgrades
			--minRefDiameter = 1, -- smallest (bike is 2, f100/sedan about 6, bus is 13)
			--maxRefDiameter = 2, -- 
			regenerate = 120,
			percentage = 75,
			spawn = "RandomChickenCoopLoot",
			gridsize = 3,
			forceinteraction = true,
			--tactical = false,
			--toolrequired = true,
			AIResponseChance = 5, -- this is the tool harvest chance should be relatively low (5 in 1000 now)
			AIResponseStrCategory = "ai_actionable_chicken",
		},
		...
		-------------------------------------------------------------------------------------------------------------
		{
			...
			--surface = { "mat_wood_harvest" },
			model = {
                "Objects/NationZ/basebuilding/farm/PigPen/shed.cgf",
			},
			sound = "Play_bush_movement_dry_large",
			--minUses = 1, -- this is one basepart upgrade
			uses = 2, -- this is 5 basepart upgrades
			...
			regenerate = 120,
			percentage = 75,
			spawn = "RandomPigpenLoot",
			gridsize = 3,
			forceinteraction = true,
			--tactical = false,
			--toolrequired = true,
			AIResponseChance = 5, -- this is the tool harvest chance should be relatively low (5 in 1000 now)
			AIResponseStrCategory = "ai_actionable_pig",
		},
		...
		--------------------------------------------------
		{
			...
			regenerate = 120,
			percentage = 65,
			spawn = "RandomCraftingGuide", -- have ItemSpawnerManager spawn something from the RandomAmmo category
			forceinteraction = true,
		},
		...
		-- clams (on beaches)
		{
			...
			tactical = false,
				...
				-- cacti
				{
					...
					fail = "@nothing_usable_was_found",
					model = { 
						"objects/basebuilding/landscaping/desert_plants/opuntia/porkchop_OpuntiaFl02.cgf",
						"objects/basebuilding/landscaping/desert_plants/opuntia/porkchop_OpuntiaFl03.cgf",
						"objects/basebuilding/landscaping/desert_plants/opuntia/porkchop_OpuntiaFl04.cgf",
						"objects/basebuilding/landscaping/desert_plants/opuntia/porkchop_OpuntiaFl01.cgf",
					},
					material = { "objects/basebuilding/landscaping/desert_plants/opuntia/opuntia", },
					sound = "Play_bush_movement_dry_large",
					uses = 1,
					regenerate = 360,
					percentage = 40,
