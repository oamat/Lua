...
AISpawnerManager = {
	...
	aiCategories =
	{
...

		{
			...
			classes =
			{
				...
				{ class = "BruteMutant", percent = 100,
					models =
					{
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored.cdf", percent = 25.0 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored_dark.cdf", percent = 25.0 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored_es1.cdf", percent = 25.0 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored_es2.cdf", percent = 25.0 },
					},
				},
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "Crazy", percent = 100,
					...
					{ name = "objects/characters/bandits/crazy/crazy.cdf", percent = 4.0 },
		...
		{
			category = "PigSingle",        --NationZ
			classes =
			{
				{
					class = "Pig", percent = 100,
					models =
					{
						{ name = "objects/characters/animals/pig/pig.cdf", percent = 100 },
					},
				},
			},
		},
		...
		{
			category = "RoosterSingle",        --NationZ
			classes =
			{
				{
					class = "Rooster", percent = 100,
					models =
					{
						{ name = "objects/characters/animals/birds/rooster/rooster.cdf", percent = 100 },
					},
				},
			},
		},
		...
		{
			category = "ai_actionable_chicken",    --Nationz
			classes = 
			{
				{ category = "RoosterSingle", percent = 100 },
			},
		},
		
		{
			category = "ai_actionable_pig",        --NationZ
			classes = 
			{
				{ category = "PigSingle", percent = 100 },
			},
		},
		{
